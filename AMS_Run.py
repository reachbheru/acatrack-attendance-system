    ...
    def fill_attendance():
        ...
        if subb == '':
            ...
            def create_csv():
                ...
                csv_name = 'D:/acatrack-attendance-system/Attendance/Manually Attendance/'+DB_table_name+'.csv'
            ...
            def attf():
                import subprocess
                subprocess.Popen(
                    r'explorer /select,"D:/acatrack-attendance-system/Attendance/Manually Attendance/-------Check atttendance-------"')
...
def subjectchoose():
    def Fillattendances():
        ...
        if time.time() < future:
            if sub == '':
                ...
                root.configure(background='grey80')
                cs = 'D:/acatrack-attendance-system/' + fileName
    ...
    def Attf():
        import subprocess
        subprocess.Popen(
            r'explorer /select,"D:/acatrack-attendance-system/Attendance/-------Check atttendance-------"')
    ...
    def log_in():
        ...
        if username == 'admin':
            if password == 'admin123':
                ...
                cs = 'D:/acatrack-attendance-system/StudentDetails/StudentDetails.csv'
                with open(cs, newline="") as file:
                    reader = csv.reader(file)
                    r = 0
